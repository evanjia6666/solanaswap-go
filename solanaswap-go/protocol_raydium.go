...
// owns the transfer-scan + init-liquidity + setTxPoolInfo logic. The RAYDIUM_AMM_ROUTER
// program is a router and is handled separately.
...
func (raydiumParser) dedupKey() string { return PROTOCOL_RAYDIUM }
