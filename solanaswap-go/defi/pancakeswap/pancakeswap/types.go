...
func (obj PermissionlessFarmSwitch) MarshalWithEncoder(encoder *binary.Encoder) (err error) {
	// Serialize `Bump`:
	err = encoder.Encode(obj.Bump)
	if err != nil {
		return errors.NewField("Bump", err)
	...
	if err != nil {
		return errors.NewField("IsOn", err)
	}
	return nil
}

func (obj PermissionlessFarmSwitch) Marshal() ([]byte, error) {
	buf := bytes.NewBuffer(nil)
	encoder := binary.NewBorshEncoder(buf)
	err := obj.MarshalWithEncoder(encoder)
	if err != nil {
		return nil, fmt.Errorf("error while encoding PermissionlessFarmSwitch: %w", err)
	}
	return buf.Bytes(), nil
}

func (obj *PermissionlessFarmSwitch) UnmarshalWithDecoder(decoder *binary.Decoder) (err error) {
	// Deserialize `Bump`:
	err = decoder.Decode(&obj.Bump)
	if err != nil {
		return errors.NewField("Bump", err)
...
func (obj *PermissionlessFarmSwitch) Unmarshal(buf []byte) error {
	err := obj.UnmarshalWithDecoder(binary.NewBorshDecoder(buf))
	if err != nil {
		return fmt.Errorf("error while unmarshaling PermissionlessFarmSwitch: %w", err)
	}
	return nil
}

func UnmarshalPermissionlessFarmSwitch(buf []byte) (*PermissionlessFarmSwitch, error) {
	obj := new(PermissionlessFarmSwitch)
	err := obj.Unmarshal(buf)
	if err != nil {
		return nil, err
	}
