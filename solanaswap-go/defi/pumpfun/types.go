...
type BondingCurve struct {
	...
	VirtualQuoteReserves uint64             `json:"virtualQuoteReserves"`
	RealTokenReserves    uint64             `json:"realTokenReserves"`
	RealQuoteReserves    uint64             `json:"realQuoteReserves"`
...
type Global struct {
	...
	InitialVirtualQuoteReserves uint64                `json:"initialVirtualQuoteReserves"`
	WhitelistedQuoteMints       [1]solanago.PublicKey `json:"whitelistedQuoteMints"`
}
